#' Reference Matrix
#'
#' a \code{matrix} containing the signal intensity for phenotypic and functional markers measured using CyTOF
...
#'
#' A \code{data.frame} containing the source file and cell type for every cell in \code{\link{refMat}},
