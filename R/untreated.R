#' Untreated Samples with 4 Different Treatments
#'
#' a \code{matrix} containing the signal intensity for phenotypic and functional markers
#' measured using CyTOF on different cell types, after stimulation with BCR/FcR-XL, PMA/Ionomycin
#' and vanadate. See
#' \href{http://www.nature.com/nbt/journal/v30/n9/full/nbt.2317.html}{Bodenmiller et al 2012}
#' for details.
#'
#' @format a matrix with 15792 rows and 23 variables, 9 phenotypic:
#' \itemize{
#'    \item{ CD20 }
#'    \item{ IgM }
#'    \item{ CD4 }
...
#' \code{\link{refMat}}, \code{\link{refPhenoMat}} and \code{\link{refFuncMat}}.
...
#'    \item{Treatment}{the treatment for the corresponding row in \code{\link{refMat}}}
#'    \item{Cells}{the cell type for the corresponding row in \code{\link{refMat}}}
#' }
#' @source \url{http://reports.cytobank.org/105/v2}
"untreatedAnnots"
